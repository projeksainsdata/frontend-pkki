...
const ConnectWithUs = () => {
  return (
    <div className="flex flex-col items-center justify-center mx-10 mt-32 gap-5">
      <div className="flex flex-col md:flex-row text-colorGreen items-center justify-between w-full">
        <h1 className="text-5xl font-spaceGrotesk font-bold text-center md:text-left">Kontak Kami</h1>
      </div>
      <div className="flex flex-col md:flex-row gap-3 w-full">
        <Link className='bg-colorUngu py-3 px-5 rounded text-md text-center text-white w-full'>+6285643290340 (Selvi-Paten)</Link>
        <Link className='bg-colorUngu py-3 px-5 rounded text-md text-center text-white w-full'>+6285280620763 (Mentari-Hakcipta)</Link>
        <Link className='bg-colorUngu py-3 px-5 rounded text-md text-center text-white w-full'>+6281373862262 (Putri-Desain Industri)</Link>
      ...
      <div className="flex flex-col items-center w-full mt-8">
        ...
        <Link
          className="bg-colorGreen py-3 px-5 rounded text-md text-center text-colorItera w-full md:w-auto font-semibold hover:bg-blue-700 transition-colors"
